...
import UniversalGradesTable from '../analyiscomponents/UniversalGradesTable'; // Fixed import
...
const AnalysisPage = () => {
  ...
  return (
    // Removed inline style here. Now using className "analysis-page-container"
    <div className={`analysis-page-container ${isDark ? 'dark' : 'light'}`}>
      
      {/* Removed inline style here. Now using className "analysis-nav" */}
      <nav className={`analysis-nav ${isDark ? 'dark' : 'light'}`}>
           ...
           <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="relative">
                ...
                {/* Dropdown Menu */}
                {showProfileDropdown && (
                  // Removed inline style here. Now using className "profile-dropdown-menu"
       ...
       <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Removed inline style here. Now using className "analysis-card" */}
